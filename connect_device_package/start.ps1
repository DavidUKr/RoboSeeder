...
node aws-iot-device-sdk-js-v2\samples\node\pub_sub\dist\index.js --endpoint a1o2jgwfehdoq5-ats.iot.eu-north-1.amazonaws.com --ca_file root-CA.crt --key ES_thing.private.key --cert ES_thing.cert.pem --client_id sdk-nodejs-v2 --topic sdk/test/js